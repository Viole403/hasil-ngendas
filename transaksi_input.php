   	        ...
   	        <tbody>
            	<tr>
                    ...
                    <td><select name="buku">
                        ...
                        <?php 
                            $query = $konek->query("SELECT * FROM tbl_buku ORDER by id");
                ...
                <tr>
                    ...
                    <td><select name="peminjam">
                        ...
                        <?php 
							$query = $konek->query("SELECT * FROM tbl_anggota ORDER by nim");
                ...
                <tr>
                    <td><a href="?page=transaksi" class=tombol>Kembali</td>
                </tr>
