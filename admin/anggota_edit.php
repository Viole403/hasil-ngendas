...
$nim = $_GET['nim'];
$anggota=$konek->query ("SELECT * FROM tbl_anggota where nim='$nim'");
   	      ...
   	      <table width="100%" height="80%" align="center" cellspacing="0" cellpadding="5">
   	        <tbody>
            	<tr>
                    ...
                    <td><input type="text" name="nim1" size="50%" required="required" value="<?php echo $nim; ?>"></td>
                </tr>
                <tr>
                	<td width="20%" align="right">Nama Lengkap</td>
                    <td><input type="text" name="nama" size="50%" required="required" value="<?php echo $nama; ?>"></td>
                </tr>
                <tr>
                	<td width="20%" align="right">Tempat Lahir</td>
                    <td><input type="text" name="tempat_lahir" size="50%" required="required" value="<?php echo $tempat; ?>"></td>
                </tr>
                <tr>
                	<td width="20%" align="right">Tanggal Lahir</td>
                    <td><input type="date" name="tgl_lahir" required="required" value="<?php echo $tgl_lahir; ?>"></td>
                </tr>
                <tr>
                	<td width="20%" align="right">Jenis Kelamin</td>
                    <td required="required"><?php if ($data['jk'] === "L") : ?>
                ...
                <tr>
                    ...
                    <td><input type="text" name="thn_masuk" size="50%" required="required" value="<?php echo $thn; ?>"></td>
                </tr>
                <tr>
                	<td></td>
