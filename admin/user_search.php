	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
        	...
        	<table width="100%" height="100%">
            	<tr>
                	<td width="50%"><a href="?page=user_input" class="tombol">Input User</a></td>
        ...
        <?php $cari = $_POST['cari'];?>
        <?php $no=1;?>
        <?php $cari_user=$konek->query ("SELECT * FROM tbl_user WHERE nama like '%$cari%' OR username like '%$cari%' ");?>
        <?php $total = mysqli_num_rows($cari_user);?>
        <?php while($data=$cari_user->fetch_assoc()){?>
   	        <tbody>
   	          <tr>
