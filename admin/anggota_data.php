	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
        	...
        	<table width="100%" height="100%" >
            	<tr>
                	<td width="50%"><a href="?page=anggota_input" class="tombol">Input Anggota</a></td>
        ...
        <?php $no=1;?>
        <?php $tampil_anggota=$konek->query ("SELECT * FROM tbl_anggota ORDER by nim");?>
        <?php $total = mysqli_num_rows($tampil_anggota);?>
        <?php while($data=$tampil_anggota->fetch_assoc()){?>
   	        ...
   	        <tbody>
                ...
                <td align="center"><div class="tombol-opsi-container"><a href="?page=anggota_detil&nim=<?php echo $data['nim']; ?> width="15px" height="15px" class="tombol">Detail</a></div></td>
