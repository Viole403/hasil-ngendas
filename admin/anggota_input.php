   	      ...
   	      <table width="100%" height="80%" align="center" cellspacing="0" cellpadding="5">
   	        <tbody>
            	<tr>
                    ...
                    <td><input type="text" name="nim" size="50%" required="required"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="tempat_lahir" size="50%" required="required"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="thn_masuk" size="50%" required="required"></td>
                </tr>
                <tr>
                	<td></td>
                ...
                <tr>
                    <td><a href="?page=anggota" class=tombol>Kembali</td>
                </tr>
