	...
	<div id="menu-tengah">
        ...
        <div id="menu_header">
        	...
        	<table width="100%" height="100%" >
            	<tr>
                	<td width="50%"><a href="?page=buku_input" class="tombol">Input Buku</a></td>
           ...
           <?php
		   	...
		   	<?php $cari = $_POST['cari'];?>
        <?php $no=1;?>
        <?php $cari_buku=$konek->query ("SELECT * FROM tbl_buku where judul like '%$cari%' OR pengarang like '%$cari%' ");?>
        <?php $total = mysqli_num_rows($cari_buku);?>
        <?php while($data=$cari_buku->fetch_assoc()){?>
           <tbody>
   	          <tr>
